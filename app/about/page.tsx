  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="min-h-[100dvh] flex flex-col items-center justify-center relative pt-20">
        <FadeIn direction="up" className="text-center w-full max-w-5xl px-4 flex flex-col items-center">
        ...
        <FadeIn delay={0.4} className="absolute bottom-16 text-2xl md:text-3xl font-medium tracking-tight">
          by Apipi Team
        </FadeIn>
      </section>
      ...
      <section className="py-32 px-6 md:px-12 max-w-5xl mx-auto flex flex-col md:flex-row gap-20 items-center">
        ...
        <FadeIn direction="right" delay={0.2} className="flex-1 w-full flex justify-center md:justify-end">
